<h2 style="color:black">Catatan Penjualan</h2> <br>
              ...
              <table style="width:100%">
                ...
                <tr>
                    ...
                    <td style="text-align:center">
                        <?php echo anchor('home/hapusPembeli/'.$a->iddetail,'<span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Hapus');?>  </td>
                </tr>
                <?php }?>
              </table>
<br>
